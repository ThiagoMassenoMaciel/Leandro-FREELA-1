...
export interface ApiPaginaHomePaginaHome extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: "pagina_home";
    pluralName: "pagina-homes";
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sessoes: Schema.Attribute.DynamicZone<
      [
        "sessoes.servicos-sessao-um",
        "sessoes.servicos-sessao-tres",
        "sessoes.servicos-sessao-quatro",
        "sessoes.servicos-sessao-dois",
        "sessoes.home-sessao-um",
        "sessoes.home-sessao-dois",
        "sessoes.home-sessao-tres",
        "sessoes.home-sessao-quatro",
...
export interface ApiPaginaServicoPaginaServico extends Struct.SingleTypeSchema {
  collectionName: "pagina_servicos";
  info: {
    displayName: "pagina_servico";
    pluralName: "pagina-servicos";
    singularName: "pagina-servico";
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::pagina-servico.pagina-servico"
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
